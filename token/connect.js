...
async function fetchAccountData() {
  ...
  const rowResolvers = accounts.map(async (address) => {
   ...
   // const humanFriendlyBalance3 = parseFloat(cakeBalancecwj).toFixed(4);
    ...
    //HKD Token 
    document.querySelector(".hkdbalance").textContent = humanFriendlyBalance2;
    document.querySelector(".hkd").innerHTML =contractaddress ;
    document.querySelector(".hkdscan").innerHTML = "<a href='https://bscscan.com/address/0x40a3d513f580a3259cec01c059b521a5dda2aa3a'; target='_blank' >VerifiedSmartContract</a>" ;
    //Cake Token
...
addToken.addEventListener('click', () =>{
  ethereum.request({
    ...
    params: {
      type: 'ERC20',
      options: {
        address: '0x40a3d513f580a3259cec01c059b521a5dda2aa3a',
        symbol: 'HKD',
        decimals: 18,
        image: 'https://gaswapper.github.io/logo.png',
      },
    },
  });
});
